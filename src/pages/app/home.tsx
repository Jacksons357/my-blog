          ...
          <div className="grid grid-cols-2 p-3">
            <div className="text-muted-foreground text-sm space-y-5 tracking-wide text-justify mt-20">
              ...
              <p>
                ...
                tecnologia. Esse interesse me guiou até o desenvolvimento
                front-end, onde encontro soluções criativas para transformar
                ideias em realidade. Atualmente, estou me formando em Análise e
              ...
              <p>
                ...
                diariamente, assim como faço no meu trabalho. Amo compartilhar o
                que aprendo e acredito que ensinar e trocar experiências são
                fundamentais para o crescimento. Cada dia é uma nova
                oportunidade de aprender, superar desafios e me aproximar de
                meus objetivos.
              </p>
            </div>
